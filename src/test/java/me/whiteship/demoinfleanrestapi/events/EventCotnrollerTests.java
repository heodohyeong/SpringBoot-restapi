...
//@WebMvcTest
public class EventCotnrollerTests extends BaseControllerTest {
    ...
    @Test
    @TestDescription("정삭적으로 이벤틀르 생성하는 테스트")
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                            links(
                                    ...
                                    linkWithRel("update-event").description("link to update ans existing event"),
                           ...
                           relaxedResponseFields(
                                    ...
                                    fieldWithPath("beginEnrollmentDateTime").description("date time of begin of new event"),
                                    fieldWithPath("closeEnrollmentDateTime").description("date time of close of new event"),
                                    fieldWithPath("beginEventDateTime").description("date time of begin if new event"),
                                    fieldWithPath("endEventDateTime").description("date time if end of new event"),
                                    fieldWithPath("location").description("location of new event"),
                                    fieldWithPath("basePrice").description("base price of new event"),
                                    fieldWithPath("maxPrice").description("max price of new event"),
    ...
    @Test
    @TestDescription("30개의 이벤틀를 10개씩 두번째 페이지 조회하기")
    ...
    public void updateEvent() throws Exception {
        //Given
        Account account = this.createAccount();
        Event event = this.generateEvent(300 , account);
